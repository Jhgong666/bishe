...
class RecMainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None, *args, **kwargs):
        ...
        QWindowCtrls(self, exit_title="基于YOLOv8/v5的人脸表情识别系统",  # 退出确认框标题
        ...
        self.superimposed_images = []  # 待保存的热力图
        ...
        self.count_name = ["愤怒", "轻蔑", "厌恶", "恐惧", "快乐", "中性", "悲伤", "惊讶"]  # 定义类名列表
    ...
    def frame_process(self, image):
        ...
        self.superimposed_images.append(superimposed_img)
